  ...
  '/deals': {
    ...
    es: {
      ...
      features: [
        ...
        'Una oportunidad presentada por un socio lleva su nombre en la tarjeta, y se reconoce en nuestro pipeline sin tener que abrirla — el margen es suyo, y un descuento es una concesion a una empresa y no a un cliente. Dentro, "Sold through" viene del acuerdo con ese socio en vez de preguntarse en cada oportunidad, que es lo que hace visibles el precio al cliente final, nuestro precio de transferencia y el margen del socio. El rol se define una vez por empresa en Permisos → Empresas, y se puede sobreescribir en un caso puntual.',
