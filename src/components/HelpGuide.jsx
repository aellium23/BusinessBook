  ...
  '/': {
    en: {
      ...
      features: [
        ...
        'Summary: gauges comparing actuals vs budget. Classic: monthly charts + funnel.',
      ...
      steps: [
        ...
        '2. Summary — gauges of actuals vs budget (adjusts for elapsed months).',
        '3. Classic — detailed monthly bar charts and funnel analytics.',
    ...
    es: {
      ...
      features: [
        ...
        'Resumen: gauges reales vs presupuesto. Clasico: graficos mensuales + embudo.',
      ...
      steps: [
        ...
        '2. Resumen — gauges de reales vs presupuesto (ajusta por meses transcurridos).',
        '3. Clasico — graficos mensuales detallados y analisis del embudo.',
    ...
    pt: {
      ...
      features: [
        ...
        'Resumo: gauges reais vs orcamento. Classico: graficos mensais + funil.',
      ...
      steps: [
        ...
        '2. Resumo — gauges de reais vs orcamento (ajusta pelos meses decorridos).',
        '3. Classico — graficos mensais detalhados e analise do funil.',
