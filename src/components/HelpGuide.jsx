...
const HELP = {
  ...
  '/deals': {
    ...
    pt: {
      ...
      features: [
        'Deal rapido: o caminho mais curto para uma oportunidade com preco. O pais ja vem preenchido a partir da tua unidade de negocio (VGT Portugal, ECT Espanha) e a lista de paises tem pesquisa. Escolhe o cliente, escreve o volume anual de estudos e toca nos produtos, agrupados por categoria quando abres o catalogo completo \u2014 o volume seleciona o escalao de todos de uma vez, e aparecem custo, margem, margem bruta em euros e preco de venda. Ajusta a margem por linha e o preco acompanha. A margem e margem bruta sobre a venda, a mesma definicao do GM% do negocio e do orcamento. Os produtos sem tabela de precos publicada — Synapse PACS, VNA, a IA dos parceiros — sao orcamentados a partir do custo com uma margem inicial de 25% e aparecem como "cost + margin" em vez de um escalao, para que um negocio de PACS seja orcamentado no mesmo ecra que um de CWM. Ao escolher uma familia com tabela de precos do fornecedor \u2014 Synapse 3D, PACS/Compute/VNA \u2014 abre o detalhe dos SKU reais e do que cada um nos custa. No Synapse 3D e no Mobility, escolhe a linha de packages em que o cliente esta \u2014 Base, Radiology, Full, Mobility 3D Full \u2014 e escreve o numero de utilizadores concorrentes; e calculada a combinacao mais barata dentro dessa linha: 13 utilizadores de Base sao um package de 10 CCU mais um de 3 CCU, e nao treze licencas avulso. As capacidades so somam dentro da mesma linha, por isso a escolha da linha e tua: um Base de 10 CCU mais um Cardiology de 1 CCU sao dois produtos diferentes, nao onze utilizadores.',
