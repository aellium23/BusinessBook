  ...
  '/deals': {
    ...
    es: {
      ...
      features: [
        ...
        'Una oportunidad presentada por un socio lleva su nombre en la tarjeta, y se reconoce en nuestro pipeline sin tener que abrirla — el margen es suyo, y un descuento es una concesion a una empresa y no a un cliente. Dentro, "Sold through" viene del acuerdo con ese socio en vez de preguntarse en cada oportunidad, que es lo que hace visibles el precio al cliente final, nuestro precio de transferencia y el margen del socio. El rol se define una vez por empresa en Permisos → Empresas — o una vez por region de precio, en la misma pantalla, de modo que solo las excepciones necesiten ajuste por empresa. La region de precio dice cuanto vale la lista en ese pais y se deriva de el; el rol de canal dice que hace el socio por nosotros y es un contrato, asi que la region presta un valor por defecto en vez de decidir.',
    ...
    pt: {
      ...
      features: [
        ...
        'Um negocio criado por um parceiro leva o nome dele no cartao, e reconhece-se no nosso pipeline sem ser preciso abri-lo — a margem e dele, e um desconto ali e uma concessao a uma empresa e nao a um cliente. La dentro, o "Sold through" vem do acordo com esse parceiro em vez de ser perguntado em cada negocio, e e isso que torna visiveis o preco ao cliente final, o nosso preco de transferencia e a margem do parceiro. O papel define-se uma vez por empresa em Permissoes → Empresas — ou uma vez por regiao de preco, no mesmo ecra, de modo que so as excepcoes precisem de definicao por empresa. A regiao de preco diz quanto vale a lista naquele pais e deriva-se dele; o papel de canal diz o que o parceiro faz por nos e e contrato, por isso a regiao empresta um valor por omissao em vez de decidir.',
