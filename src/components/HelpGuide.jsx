...
const HELP = {
  ...
  '/deals': {
    en: {
      ...
      features: [
        'Quick quote: the fastest path to a priced opportunity. Pick the client, type the annual study volume, tap the products \u2014 the study volume selects the tier on every product at once, and cost, margin, gross margin in euros and sell price appear immediately. Adjust the margin per line; the sell price follows. Margin is gross margin on the sell price, the same definition as the deal GM% and the Budget. Products with no published price list — Synapse PACS, VNA, the partner AI — are quoted from cost at a 25% starting margin and marked "cost + margin" instead of a tier, so a PACS deal is quoted in the same screen as a CWM one. Picking a family that carries a supplier price list \u2014 Synapse 3D, PACS/Compute/VNA \u2014 opens a drill-down to the actual SKUs and what each costs us. For Synapse 3D, type the number of concurrent users and the cheapest package combination is worked out: 13 users is a 10 CCU plus a 3 CCU package, not thirteen single licences.',
