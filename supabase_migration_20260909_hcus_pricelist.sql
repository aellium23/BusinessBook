...
insert into public.product_items
  ...
  ('SYNAPSE-MOB', 'HCUS', '800048976', 'INT SYN MOB ENT LIC 10K FOR OPEX (ANNUAL /3 yr minimum)', 'Mobility - Enterprise License (FULL 3D) for 10k studies - Operational Expense Model (Annual Fee) 3 year Minimum requirement', 'Synapse Mobility - OPEX', 'module', 'block_10k', null, null, null, 1386.9, null, null, null, null, 18),
  ...
  ('AVICENNA', 'HCUS', '800052410', 'AIPF - INT EU AVICENNA AI ICH (1K-6K)', 'AIPF - INT EU AVICENNA AI ICH (1K-6K)', 'Volume Based License', 'module', 'unit', null, 1000, 6000, 0.72, null, null, null, null, 12),
  ('AVICENNA', 'HCUS', '800052409', 'AIPF - INT EU AVICENNA AI ICH-ASPECTS (1K-6K)', 'AIPF - INT EU AVICENNA AI ICH-ASPECTS (1K-6K)', 'Volume Based License', 'module', 'unit', null, 1000, 6000, 1.74, null, null, null, null, 13),
  ('AVICENNA', 'HCUS', '800052405', 'AIPF - INT EU AVICENNA AI ICH-LVO (1K-6K)', 'AIPF - INT EU AVICENNA AI ICH-LVO (1K-6K)', 'Volume Based License', 'module', 'unit', null, 1000, 6000, 4.53, null, null, null, null, 14),
  ('AVICENNA', 'HCUS', '800052413', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPECTS (1K-6K)', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPECTS (1K-6K)', 'Volume Based License', 'module', 'unit', null, 1000, 6000, 5.37, null, null, null, null, 15),
  ...
  ('AVICENNA', 'HCUS', '800052397', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPECTS 10K-15K', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPECTS 10K-15K', 'Volume Based License', 'module', 'study', null, null, null, 4.33, null, null, null, null, 27),
  ('AVICENNA', 'HCUS', '800052398', 'AIPF - INT EU AVICENNA AI ICH (15K-50K)', 'AIPF - INT EU AVICENNA AI ICH (15K-50K)', 'Volume Based License', 'module', 'unit', null, 15000, 50000, 0.32, null, null, null, null, 30),
  ('AVICENNA', 'HCUS', '800052392', 'AIPF - INT EU AVICENNA AI ICH-ASPECTS (15K-50K)', 'AIPF - INT EU AVICENNA AI ICH-ASPECTS (15K-50K)', 'Volume Based License', 'module', 'unit', null, 15000, 50000, 0.68, null, null, null, null, 31),
  ('AVICENNA', 'HCUS', '800052394', 'AIPF - INT EU AVICENNA AI ICH-LVO (15K-50K)', 'AIPF - INT EU AVICENNA AI ICH-LVO (15K-50K)', 'Volume Based License', 'module', 'unit', null, 15000, 50000, 1.91, null, null, null, null, 32),
  ('AVICENNA', 'HCUS', '800052395', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPEC (15K-50K)', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPEC (15K-50K)', 'Volume Based License', 'module', 'unit', null, 15000, 50000, 2.26, null, null, null, null, 33),
  ('AVICENNA', 'HCUS', '800052389', 'AIPF - INT EU AVICENNA AI ICH (50K-100K)', 'AIPF - INT EU AVICENNA AI ICH (50K-100K)', 'Volume Based License', 'module', 'unit', null, 50000, 100000, 0.23, null, null, null, null, 36),
  ('AVICENNA', 'HCUS', '800052401', 'AIPF - INT EU AVICENNA AI ICH-ASPECTS(50K-100K)', 'AIPF - INT EU AVICENNA AI ICH-ASPECTS(50K-100K)', 'Volume Based License', 'module', 'unit', null, 50000, 100000, 0.49, null, null, null, null, 37),
  ('AVICENNA', 'HCUS', '800052387', 'AIPF - INT EU AVICENNA AI ICH-LVO (50K-100K)', 'AIPF - INT EU AVICENNA AI ICH-LVO (50K-100K)', 'Volume Based License', 'module', 'unit', null, 50000, 100000, 1.37, null, null, null, null, 38),
  ('AVICENNA', 'HCUS', '800052393', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPEC (50K-100K)', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPEC (50K-100K)', 'Volume Based License', 'module', 'unit', null, 50000, 100000, 1.61, null, null, null, null, 39),
  ('AVICENNA', 'HCUS', '800052390', 'AIPF - INT EU AVICENNA AI ICH (100K+)', 'AIPF - INT EU AVICENNA AI ICH (100K+)', 'Volume Based License', 'module', 'unit', null, null, null, 0.18, null, null, null, null, 42),
  ('AVICENNA', 'HCUS', '800052386', 'AIPF - INT EU AVICENNA AI ICH-ASPECTS (100K+)', 'AIPF - INT EU AVICENNA AI ICH-ASPECTS (100K+)', 'Volume Based License', 'module', 'unit', null, null, null, 0.37, null, null, null, null, 43),
  ('AVICENNA', 'HCUS', '800052391', 'AIPF - INT EU AVICENNA AI ICH-LVO (100K+)', 'AIPF - INT EU AVICENNA AI ICH-LVO (100K+)', 'Volume Based License', 'module', 'unit', null, null, null, 1.05, null, null, null, null, 44),
  ('AVICENNA', 'HCUS', '800052385', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPECTS (100K+)', 'AIPF - INT EU AVICENNA AI ICH-LVO-ASPECTS (100K+)', 'Volume Based License', 'module', 'unit', null, null, null, 1.25, null, null, null, null, 45),
  ...
  ('CONTEXTFLOW', 'HCUS', null, 'CFACCT_BASIC', 'ADVANCE Chest CT - Basic without any prior', 'Contextflow Parts Number', 'module', 'unit', null, null, null, 0.7, null, null, null, null, 8),
  ('CONTEXTFLOW', 'HCUS', null, 'CFACCT_LNT_1PRIORS', 'ADVANCE Chest CT - Lung Nodule Timeline 1 prior', 'Contextflow Parts Number', 'module', 'unit', null, null, null, 1.4, null, null, null, null, 9),
  ('CONTEXTFLOW', 'HCUS', null, 'CFACCT_LNT_2PRIORS', 'ADVANCE Chest CT - Lung Nodule Timeline 2 priors', 'Contextflow Parts Number', 'module', 'unit', null, null, null, 2.1, null, null, null, null, 10),
  ('CONTEXTFLOW', 'HCUS', null, 'CFACCT_LNT_3PRIORS', 'ADVANCE Chest CT - Lung Nodule Timeline 3 priors', 'Contextflow Parts Number', 'module', 'unit', null, null, null, 2.8, null, null, null, null, 11),
  ('CONTEXTFLOW', 'HCUS', null, 'CFACCT_LNT_4+PRIORS', 'ADVANCE Chest CT - Lung Nodule Timeline 4 and more priors', 'Contextflow Parts Number', 'module', 'unit', null, null, null, 3.5, null, null, null, null, 12),
  ('CONTEXTFLOW', 'HCUS', null, 'CFACCT_IPE', 'ADVANCE Chest CT - Incidental Pulmonary Embolism', 'Contextflow Parts Number', 'module', 'unit', null, null, null, 0.7, null, null, null, null, 13),
  ('CONTEXTFLOW', 'HCUS', null, 'CFACCT_PROFESSIONAL', 'ADVANCE Chest CT - Professional: DICOM SC with segmentation of 7 patterns', 'Contextflow Parts Number', 'module', 'unit', null, null, null, 2.45, null, null, null, null, 14),
  ('CONTEXTFLOW', 'HCUS', null, 'CFACCTT_SEARCH', 'ADVANCE Chest CT - Search', 'Contextflow Parts Number', 'module', 'unit', null, null, null, 0.7, null, null, null, null, 15),
  ...
  ('LUNIT', 'HCUS', null, 'Lunit CXR License (Tier 1 - 1K)', 'Lunit CXR License (Tier 1 - 1K)', 'FEN Parts Description', 'module', 'study', null, 1, 1, 0.78, null, null, null, null, 9),
  ('LUNIT', 'HCUS', null, 'Lunit CXR License (Tier 2 - 9K)', 'Lunit CXR License (Tier 2 - 9K)', 'FEN Parts Description', 'module', 'study', null, 2, 9, 0.63, null, null, null, null, 10),
  ('LUNIT', 'HCUS', null, 'Lunit CXR License (Tier 3 - 90K)', 'Lunit CXR License (Tier 3 - 90K)', 'FEN Parts Description', 'module', 'study', null, 3, 90, 0.47, null, null, null, null, 11),
  ('LUNIT', 'HCUS', null, 'Lunit CXR License (Tier 4 - 900K)', 'Lunit CXR License (Tier 4 - 900K)', 'FEN Parts Description', 'module', 'study', null, 4, 900, 0.24, null, null, null, null, 12),
  ('LUNIT', 'HCUS', null, 'Lunit MMG License (Tier 1 - 1K)', 'Lunit MMG License (Tier 1 - 1K)', 'FEN Parts Description', 'module', 'study', null, 1, 1, 1.37, null, null, null, null, 20),
  ('LUNIT', 'HCUS', null, 'Lunit MMG License (Tier 2 - 9K)', 'Lunit MMG License (Tier 2 - 9K)', 'FEN Parts Description', 'module', 'study', null, 2, 9, 1.1, null, null, null, null, 21),
  ('LUNIT', 'HCUS', null, 'Lunit MMG License (Tier 3 - 20K)', 'Lunit MMG License (Tier 3 - 20K)', 'FEN Parts Description', 'module', 'study', null, 3, 20, 0.82, null, null, null, null, 22),
  ('LUNIT', 'HCUS', null, 'Lunit MMG License (Tier 4 - 90K)', 'Lunit MMG License (Tier 4 - 90K)', 'FEN Parts Description', 'module', 'study', null, 4, 90, 0.42, null, null, null, null, 23),
  ('LUNIT', 'HCUS', null, 'Lunit MMG 2D+3D License (Tier 1 - 1K)', 'Lunit MMG 2D+3D License 0 - 1,000 per year', 'FEN Parts Description', 'module', 'study', null, 1, 1, 1.79, null, null, null, null, 32),
  ('LUNIT', 'HCUS', null, 'Lunit MMG 2D+3D License (Tier 2 - 10K)', 'Lunit MMG 2D+3D License 1,001 - 10,000 per year', 'FEN Parts Description', 'module', 'study', null, 2, 10, 1.47, null, null, null, null, 33),
  ('LUNIT', 'HCUS', null, 'Lunit MMG 2D+3D License (Tier 3 - 30K)', 'Lunit MMG 2D+3D License 10,001 - 30,000 per year', 'FEN Parts Description', 'module', 'study', null, 3, 30, 1.21, null, null, null, null, 34),
  ('LUNIT', 'HCUS', null, 'Lunit MMG 2D+3D License (Tier 4 - 120K)', 'Lunit MMG 2D+3D License 30,001 - 120,000 per year', 'FEN Parts Description', 'module', 'study', null, 4, 120, 0.71, null, null, null, null, 35),
